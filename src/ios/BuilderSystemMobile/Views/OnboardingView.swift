...
//  BuilderSystemMobile
//
//  Cloudflare Tunnel onboarding flow
//
...
struct OnboardingView: View {
    ...
    @State private var localTunnelURL = ""
        ...
        VStack(spacing: 20) {
            ...
            VStack(spacing: 16) {
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    TextField("https://viii-gmc-facing-salary.trycloudflare.com", text: $localTunnelURL)
                        .textContentType(.URL)
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    SecureField("Enter API Key", text: $localAPIKey)
    ...
    private var actionButtonEnabled: Bool {
        switch currentStep {
        case 0: return true
        case 1: return !localTunnelURL.isEmpty && !localAPIKey.isEmpty
    ...
    private func testConnection() {
        ...
        // Save credentials to API client
        apiClient.tunnelURL = localTunnelURL
